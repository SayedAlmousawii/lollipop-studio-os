...
| SessionTypes | admin-managed session taxonomy rows, frozen session-type codes, calendar labels/colors, archive state, default package-family/pricing-row creation | department CRUD, package pricing |
