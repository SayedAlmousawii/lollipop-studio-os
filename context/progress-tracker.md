...
## Now
- R8a complete: draft sidebar, POS package/photo composition, locked sales current composition, and adjustment preview cards now consume R7 composition projectors. R8b add-on marketplace projection swap is next.
