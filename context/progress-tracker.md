...
- OrderCommit execution schema is additive so far: `OrderCommitDocument` is invoice-only, `committedFromDraftVersion` is the future commit concurrency guard, and no Phase 4 execution service is wired yet.
