...
## Now
- R1b complete: all six remaining projectors live in `src/modules/financial-cases/projections/`; parity checker extended for header + orders-table-row projectors. Next: R2 (swap Financials tab + Sales locked sidebar).
