...
## Now
- R7a complete: the core `OrderCompositionViewModel` read layer and structured composition metadata exist under `src/modules/orders/composition/`; R7b projectors and the adjustment-workspace POS adapter are next.
