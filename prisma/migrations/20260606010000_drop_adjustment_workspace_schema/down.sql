...
CREATE TABLE "adjustment_workspaces" (
  ...
  "operational_state_applied_at" TIMESTAMP(3),
...
CREATE INDEX "adjustment_workspaces_invoiceId_status_idx"
  ON "adjustment_workspaces"("invoice_id", "status");
CREATE INDEX "adjustment_workspaces_orderId_status_idx"
  ON "adjustment_workspaces"("order_id", "status");
CREATE INDEX "adjustment_workspaces_currentOwnerUserId_idx"
  ON "adjustment_workspaces"("current_owner_user_id");
CREATE INDEX "adjustment_workspace_events_workspaceId_at_idx"
  ON "adjustment_workspace_events"("workspace_id", "at");
CREATE INDEX "adjustment_workspace_events_actorUserId_at_idx"
  ON "adjustment_workspace_events"("actor_user_id", "at");
CREATE INDEX "adjustment_workspace_events_eventType_at_idx"
  ON "adjustment_workspace_events"("event_type", "at");
...
ALTER TABLE "order_commits"
  ADD COLUMN "legacyAdjustmentWorkspaceId" TEXT;
