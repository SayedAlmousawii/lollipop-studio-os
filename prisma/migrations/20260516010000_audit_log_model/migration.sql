...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('INVOICE_LOCKED', 'INVOICE_UNLOCKED', 'INVOICE_TOTAL_MUTATED', 'PAYMENT_RECORDED', 'PAYMENT_REFUNDED', 'CREDIT_NOTE_ISSUED', 'ADJUSTMENT_ISSUED', 'REFUND_ISSUED', 'BOOKING_CONFIRMED', 'BOOKING_NO_SHOW', 'ORDER_LOCKED_FIELD_MUTATED');
